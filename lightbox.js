...
const redirectConfig = {
  instagram: {
    ...
    sub: 'Video ini tersedia di Instagram. Klik tombol di bawah untuk menontonnya.',
    btnText: 'Buka di Instagram',
  ...
  linkedin: {
    ...
    sub: 'Video ini tersedia di LinkedIn. Klik tombol di bawah untuk menontonnya.',
    btnText: 'Buka di LinkedIn',
    btnBg: '#0A66C2',
  }
};
